...
| 항목 | 결과 |
|---|---|
| 성공 회차 | {{VALIDATION_CYCLES}} |
| 총 테스트 | {{VALIDATION_TESTS}}건 |
| 통과율 | {{VALIDATION_PASS_RATE}} |
| 실패 회차 | 0 |
| 병렬 Worker | {{VALIDATION_WORKERS}} |
| 총 소요 시간 | {{VALIDATION_DURATION}} |
| 회차 P95 | {{VALIDATION_P95}} |
| 소스 SHA-256 | {{SOURCE_HASH}} |
